<?php 
    ...
    try {
        ...
        $sql = $conn->prepare('select ID_UsuarioA_Mensagem, ID_UsuarioB_Mensagem, Mensagem, Data_Mensagem, Nome_Usuario from Mensagem join usuario where ID_UsuarioA_Mensagem = '.$idUsuarioSessao.' and ID_UsuarioB_Mensagem = '.$_POST['id'].' and ID_Usuario = '.$idUsuarioSessao.' or 
